...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: mRKU7T_HEffn4M/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__ceZEd, {
          [sty.freeBoxlong__ceZEdldpyA]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__ouY2Y, {
            [sty.freeBoxlong__ouY2YldpyA]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__lh0Ms)}
                role={"img"}
              />
            ),
