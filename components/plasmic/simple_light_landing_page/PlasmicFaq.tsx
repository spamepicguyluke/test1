...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: TcAi2e7F1Tb9j7/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___0JVyO)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__x8Fba)}>
          <div className={classNames(projectcss.all, sty.freeBox__x1Tt6)}>
            {p.renderPlasmicSlot({
