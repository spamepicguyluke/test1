...
import sty from "./PlasmicHomeCta.module.css"; // plasmic-import: _9GT5cZdU4uBM/css
...
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: 90nBlbdry2twmv/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__bkGng)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__ixZM)}
        >
          <TextInput
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
        <div className={classNames(projectcss.all, sty.freeBox___6Z8CT)}>
          <SphereIcon
