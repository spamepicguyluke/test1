...
import BaseCard from "../../BaseCard"; // plasmic-import: mRKU7T_HEffn4M/component
...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: nu-ncLkn14L1Uq/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__pJ3U)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__i7YcU)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___0KadF)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__w0NFy)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__h945I)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__eWmht)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(projectcss.all, sty.freeBox__dYExk)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__pwQEi)}
