...
import Avatar from "../../Avatar"; // plasmic-import: djY35HDWnU14cI/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: GDvipcJoB5RgS4/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: 1wjX9ZylsSHKEl/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__aINiD)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__bnPJt)}
        >
          <div
            className={classNames(
              projectcss.all,
